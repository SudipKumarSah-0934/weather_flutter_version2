...
class _$_WeatherParams implements _WeatherParams {
  ...
  @override
  String toString() {
    return 'WeatherParams(temp: $temp, tempMin: $tempMin, tempMax: $tempMax,pressure:$pressure,humidity:$humidity)';
  }
...
abstract class _WeatherParams implements WeatherParams {
  factory _WeatherParams(
      {required double temp,
      @JsonKey(name: 'temp_min') required double tempMin,
      @JsonKey(name: 'temp_max') required double tempMax, @JsonKey(name: 'pressure') required double pressure, @JsonKey(name: 'humidity') required double humidity}) = _$_WeatherParams;
